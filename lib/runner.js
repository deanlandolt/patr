(function(define){ 
define(["promised-io/lib/promise", "promised-io/lib/process"],function(promise, processModule){

var when = promise.when;
var all = promise.all;
var print = processModule.print;
var onError;
function run(tests, args){
	if(!args){
		var params = processModule.args;
		args = {};
...
if(typeof processModule.on === "function"){
	processModule.on("uncaughtException", function(e){
		if(onError){
			onError(e);
		}else{
